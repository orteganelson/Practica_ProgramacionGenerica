...
public class VentanaUsuario extends javax.swing.JFrame {
     ...
     */
    ControladorAgendaTelefonica<Persona> controladorAgendaPersona;
    VentanaAgregarUsuario pantallaAgregarUsuario;
    
    private Persona aux;
    
    public VentanaUsuario(ControladorAgendaTelefonica controladorAgendaUsuario) {
        initComponents();
        this.setLocationRelativeTo(null);
        
        this.controladorAgendaPersona = controladorAgendaUsuario;
        pantallaAgregarUsuario = new VentanaAgregarUsuario(controladorAgendaPersona);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       int pos = jTable1.getSelectedRow();
        ...
        String cedula = (String) jTable1.getValueAt(pos, 0);
        String nombre = (String) jTable1.getValueAt(pos, 1);
        String apellido = (String) jTable1.getValueAt(pos, 2);
        String direccion = (String) jTable1.getValueAt(pos, 3);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        boolean eliminar= controladorAgendaPersona.delete(new Persona(cedula, nombre, apellido, direccion));
